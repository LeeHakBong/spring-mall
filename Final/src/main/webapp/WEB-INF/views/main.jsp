...
<body>
	...
	<div class="wrapper">
		<div class="wrap">
			...
			<div class="top_area">
				<div class="logo_area">
					<a href="/main"><img src="resources/image/logo2.png"></a>
				</div>
			...
			<div class="footer">
				<div class="footer_container">
					...
					<div class="footer_left">
						   <img src="resources/image/logo3.png">
                </div>
                <div class="footer_right">
                    (주) <strong>XC_CoRP</strong>       대표 : 윤정훈
                     <br>
                     <br>
                    사업자등록번호 : ooo-oo-ooooo
                      <br>
                      <br>	
                   <strong>1:1 문의 : 010-2045-7351</strong>(발신자 부담전화)
                    <br>
                    <br>
                    <p><strong>  COPYRIGHT(C) SINCE 2021. ALL RIGHTS RESERVED.  </strong></p>
					</div>
					<div class="clearfix"></div>
				</div>
			</div>
